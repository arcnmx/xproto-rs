...
use xproto::protocol::xcore::Family as X11Family;
...
mod file {
    ...
    #[derive(Debug)]
    pub struct XAuthorityEntries(BufReader<File>);
    ...
    impl XAuthorityEntries {
        ...
        pub fn new() -> Result<Option<XAuthorityEntries>, Error> {
...
pub type AuthInfo = (Vec<u8>, Vec<u8>);
